...
public class Direction: NSObject, URLSessionDataDelegate {
    ...
    public var isAltanative: Bool {
        didSet {
            self.alternatives = isAltanative ? "true" : "false"
        }
    }
            ...
            do {
                if self.data != nil {
                    ...
                    if direction.status == "OK"
                        ...
                        self.failuer(direction.error(code: 10058))
                    }
                }
            } catch {
